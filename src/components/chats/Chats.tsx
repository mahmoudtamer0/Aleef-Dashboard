        ...
        <div className="container">
            ...
            <div className="cm-page-header">
                ...
                <p className="cm-page-subtitle">
                    Monitor chats between users and doctors
                </p>
            </div>
                ...
                <div className="cm-sidebar">
                    ...
                    <div className="cm-sidebar-header">
                        ...
                        <div className="cm-sidebar-top">
                            ...
                            <span className="cm-sidebar-title">
                                Conversations
                            </span>

                            {
                                totalChats > 0 &&
                                <span className="cm-sidebar-count">
                                    {totalChats}
                                </span>
                            }
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="cm-chat-item-info">
                                                ...
                                                <div className="cm-chat-item-name">
                                                    {firstMember?.name || "Unknown"}
                                                </div>

                                                <div className="cm-chat-item-sub">
                                                    {secondMember?.name || "Unknown"}
                                                </div>
                        ...
                        !selectedChat ? (
                            ...
                            <>
                                <div className="cm-chat-header">
                                    ...
                                    <div>
                                        <div className="cm-chat-header-title">
                                            {getChatName(selectedChat)}
                                        </div>

                                        <div className="cm-chat-header-sub">
                                ...
                                <div className="cm-messages">

                                    {
                                        loadingMessages ? (
                                            ...
                                            <div className="cm-messages-loading">
                                                <div className="cm-spinner" />
                                            </div>

                                        ) : messages.length === 0 ? (

                                            <div className="cm-messages-empty">
                                                No messages found
                                            </div>
                                                    ...
                                                    <div key={group.label}>
...

                                                        {
                                                            group.items.map((msg) => {
                                                                ...
                                                                const isDoctor =
                                                                    msg.senderModel === "Doctor";

                                                                return (

                                                                    <div
                                                                        key={msg._id}
                                                                        className={`cm-msg-row ${isDoctor
                                                                            ? "cm-msg-row--right"
                                                                            : "cm-msg-row--left"
                                                                            }`}
                                                                    >
                                                                        ...
                                                                        <div
                                                                            className={`cm-bubble ${isDoctor
                                                                                ? "cm-bubble--doctor"
                                                                                : "cm-bubble--user"
                                                                                }`}
                                                                        >

                                                                            <div className="cm-bubble-sender">
                                                                                {msg.sender?.name}
                                                                            </div>
